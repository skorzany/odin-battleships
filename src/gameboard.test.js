  ...
  describe('public interface', () => {
    ...
    describe('.placeShip()', () => {
      describe('valid placements', () => {
        ...
        test('places horizontal ships', () => {
          ...
          horizontalShips.forEach((ship) => testBoard.placeShip(ship));
        ...
        test('places vertical ships', () => {
          ...
          verticalShips.forEach((ship) => testBoard.placeShip(ship));
          //   expected board state:
          //   _ _ _ _ _ _ _ _ _ _
          //   _ _ _ _ _ _ _ _ _ _
          //   S _ _ _ _ _ _ _ _ _
      ...
      describe('collisions', () => {
        ...
        describe('areas out of bounds', () => {
          test('handles horizontal out-of-bounds', () => {
            ...
            testBoard.placeShip(oobHorizontal);
          ...
          test('handles vertical out-of-bounds', () => {
            ...
            testBoard.placeShip(oobVertical);
            expect(testBoard.placedShips).toHaveLength(4);
            expect(testBoard.board).toEqual(expectedBoardState);
          });
        });
        describe('areas already occupied/unavailable', () => {
          test('handles horizontal overlaps', () => {
            ...
            horizontalOverlaps.forEach(([row, col]) =>
              testBoard.placeShip({ row, col, length: 2, horizontal: true })
            );
            expect(testBoard.placedShips).toHaveLength(4);
            expect(testBoard.board).toEqual(expectedBoardState);
          });
          ...
          test('handles vertical overlaps', () => {
            ...
            verticalOverlaps.forEach(([row, col]) =>
              testBoard.placeShip({ row, col, length: 2, horizontal: false })
            );
            expect(testBoard.placedShips).toHaveLength(4);
            expect(testBoard.board).toEqual(expectedBoardState);
          });
    ...
    describe('.receiveAttack()', () => {
      ...
      test('registers missed shots', () => {
        ...
        misses.forEach(([row, col]) => testBoard.receiveAttack({ row, col }));
      ...
      test('registers hits', () => {
        ...
        hits.forEach(([row, col]) => testBoard.receiveAttack({ row, col }));
